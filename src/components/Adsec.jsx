...
<footer class="bg-[#0B0E1F] text-teal-50">
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="lg:flex lg:items-start lg:gap-8">
      ...
      <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        <div class="col-span-2">
          <div>
            <h2 class="text-2xl font-bold ">Get the latest news!</h2>
        ...
        <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form class="w-full">
            ...
            <div
              class="border border-gray-100 bg-[#ffffff] p-2 focus-within:ring sm:flex sm:items-center sm:gap-4"
            >
              <input
                type="email"
                id="UserEmail"
        ...
        <div class="col-span-2 sm:col-span-1">
          ...
          <ul class="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" class=" transition hover:opacity-75"> 1on1 Coaching </a>
            </li>

            <li>
              <a href="#" class=" transition hover:opacity-75"> Company Review </a>
            </li>
            ...
            <li>
              <a href="#" class=" transition hover:opacity-75"> HR Consulting </a>
            </li>

            <li>
              <a href="#" class=" transition hover:opacity-75"> SEO Optimisation </a>
            </li>
          </ul>
        </div>
        ...
        <div class="col-span-2 sm:col-span-1">
          ...
          <ul class="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="#" class=" transition hover:opacity-75"> Meet the Team </a>
            </li>
        ...
        <div class="col-span-2 sm:col-span-1">
          ...
          <ul class="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="#" class=" transition hover:opacity-75"> Live Chat </a>
            </li>
          </ul>
        </div>
        ...
        <div class="col-span-2 sm:col-span-1">
          ...
          <ul class="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" class=" transition hover:opacity-75"> Accessibility </a>
            </li>
            ...
            <li>
              <a href="#" class=" transition hover:opacity-75"> Hiring Statistics </a>
            </li>
          </ul>
        </div>
        ...
        <div class="col-span-2 sm:col-span-1">
          ...
          <ul class="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" class=" transition hover:opacity-75"> Marketing Calendar </a>
            </li>

            <li>
              <a href="#" class=" transition hover:opacity-75"> SEO Infographics </a>
            </li>
          </ul>
        </div>
        ...
        <ul class="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
          <li>
            <a
              href="https://www.facebook.com/profile.php?id=61556603370145"
              rel="noreferrer"
              target="_blank"
    ...
    <div class="mt-8 border-t border-gray-100 pt-8">
      <div class="sm:flex sm:justify-between">
        <p class="text-xs text-gray-500">&copy; 2024. Intelex. All rights reserved.</p>
